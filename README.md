...
[^1]: *kangaroo* because it recalls the *jump* in ``reversible jump", and for consistency with Australian names for samplers such as bilby and dingo. The kangaroo is *tipsy* because it not only jumps, but sometimes it also performs *reverse* jumps.
